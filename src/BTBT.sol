...
contract BTBTaxToken is ERC20, ERC20Burnable, Ownable, ERC1363, ERC20Permit, ReentrancyGuard {
     ...
     */
    constructor(address initialOwner, address _btbToken, address _taxCollector)
        ERC20("BTBT", "BTBT")
    ...
    function initialize() external onlyOwner nonReentrant {
        ...
        require(BTB_TOKEN.transferFrom(msg.sender, address(this), INITIAL_BTB_AMOUNT), "Initial BTB transfer failed");
     ...
     */
    function previewTransfer(uint256 amount)
        external
        pure
        returns (uint256 netAmount, uint256 taxAmount, uint256 burnAmount, uint256 collectorAmount)
    {
     ...
     */
    function getStats() external view returns (uint256 btbBalance, uint256 btbtSupply, uint256 currentPrice) {
